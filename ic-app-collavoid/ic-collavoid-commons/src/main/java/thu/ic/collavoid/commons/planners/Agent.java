...
import thu.ic.collavoid.commons.rmqmsg.PoseStamped_;
...
public class Agent extends Neighbor {
    ...
    public double rot_stopped_velocity = 0.02;
    public double trans_stopped_velocity = 0.01;
    public double yaw_goal_tolerance = 0.10;
    public double xy_goal_tolerance = 0.10;
    public boolean latch_xy_goal_tolerance = true;
    public boolean ignore_goal_yaw = false;
