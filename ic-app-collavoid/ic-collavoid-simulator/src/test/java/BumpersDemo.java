...
//            }
    ...
    public BumpersDemo() {
        ...
        add(new Box(new Vector3d(-10, 0, 0), new Vector3f(0.1f, 1, 20), this));
        add(new Box(new Vector3d(0, 0, -10), new Vector3f(20, 1, 0.1f), this));
        add(new Box(new Vector3d(10, 0, 0), new Vector3f(0.1f, 1, 20), this));
        add(new Box(new Vector3d(0, 0, 10), new Vector3f(20, 1, 0.1f), this));
...
//        for (int i = -9; i < 9; i++) {
//            add(new Robot(new Vector3d(i, 0, i), "bump"+i));
//            add(new Robot(new Vector3d(i, 0, -i), "bump"+i));
//            add(new Robot(new Vector3d(-i, 0, i), "bump"+i));
//            add(new Robot(new Vector3d(-i, 0, -i), "bump"+i));
//        }
        add(new Robot(new Vector3d(1, 0, 0), "bump1"));
        add(new Robot(new Vector3d(-1, 0, 0), "bump2"));
